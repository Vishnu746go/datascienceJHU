...
NEI_data <- readRDS("C:/Users/vishn/Downloads/mydownloads/EDA IN R/exdata_data_NEI_data/summarySCC_PM25.rds")
SCC_data <- readRDS("C:/Users/vishn/Downloads/mydownloads/EDA IN R/exdata_data_NEI_data/Source_Classification_Code.rds")
...
ggplot(combustionNEI, aes(x = factor(year), y = Emissions / 10^5)) +
  ...
  # Customize axis and title labels
  labs(
    x = "Year",
    y = expression("Total PM"[2.5]*" Emission (10^5 Tons)"),
    title = expression("PM"[2.5]*" Coal Combustion Source Emissions Across US (1999-2008)")
  )
